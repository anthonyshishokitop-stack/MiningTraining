// Act 29 Mining Training - Data Module
// Extracted & modularised from original platform
...
const moduleNames = {
    ...
    pump_fluid: "Fluid handling",
    steam_pressure: "Steam Generations",
...
const videos = {
    ...
    shaft_sinking: "https://www.youtube.com/embed/DYku3FmgpZc",
    raise_drill: "https://www.youtube.com/embed/0h_Zi5BNUPA",
    lifting_operations: "https://www.youtube.com/embed/fHOlpa6_Q2s",
    civil_structural: "https://www.youtube.com/embed/lfoTLeFooR4",
    ...
    steam_pressure: "https://www.youtube.com/embed/fk3DjD9gSsk",
    electrical: "https://www.youtube.com/embed/TMT6f3tZQSk",
    mhsa: "https://www.youtube.com/embed/lMEErpFhzxg",
...
handover: {name:"SHIFT HANDOVER & PRE-CHECKS", q: [
  ...
  compressed_air: {name: "Compressed Air and Reticulation",q: [
      {"question": "Maximum allowable working pressure for standard compressed air reticulation?", "options": ["700 kPa", "1000 kPa"], "correct": 1, "explanation": "DMR limits to 1000 kPa unless specially designed."},
      {"question": "Valve required at end of every air branch line?", "options": ["Gate valve", "Self-closing dead-man valve"], "correct": 1, "explanation": "Dead-man valve prevents uncontrolled discharge."},
      {"question": "Primary purpose of moisture separators?", "options": ["Increase pressure", "Remove water/corrosion prevention"], "correct": 1, "explanation": "Prevents corrosion and freezing."},
      {"question": "Standard colour for compressed air pipelines underground?", "options": ["Red", "Blue"], "correct": 1, "explanation": "Blue is standard for compressed air."},
      {"question": "What must be fitted to air receivers?", "options": ["Safety valve", "Safety valve, pressure gauge and drain valve"], "correct": 1, "explanation": "All are mandatory per PER."},
      {"question": "Maximum hose length without support?", "options": ["5 m", "10 m"], "correct": 0, "explanation": "Hoses over 10 m require support."},
      {"question": "Purpose of aftercooler on compressor?", "options": ["Reduce temperature", "Increase pressure"], "correct": 0, "explanation": "Cools air to condense moisture."},
      {"question": "What indicates water in air lines?", "options": ["Freezing in winter", "Freezing in winter and rust in tools"], "correct": 1, "explanation": "Water causes freezing and corrosion."},
      {"question": "Minimum inspection frequency for air receivers?", "options": ["Monthly", "Annually"], "correct": 1, "explanation": "Annual external, 36-month internal per PER."},
      {"question": "What protects against overpressure in air lines?", "options": ["Relief valve", "Relief valve and pressure switch"], "correct": 1, "explanation": "Both devices required."},
      {"question": "Standard thread for air hose couplings?", "options": ["BSP", "NPT"], "correct": 0, "explanation": "BSP is standard in South Africa."},
      {"question": "Purpose of oil/water separator?", "options": ["Remove contaminants", "Increase efficiency"], "correct": 0, "explanation": "Prevents oil pollution."},
      {"question": "What must be done before opening air line?", "options": ["Depressurise", "Nothing"], "correct": 0, "explanation": "Full depressurisation required."},
      {"question": "Minimum pipe size for main air header?", "options": ["25 mm", "Depends on flow"], "correct": 1, "explanation": "Sized according to flow and pressure drop."},
      {"question": "What causes excessive pressure drop in reticulation?", "options": ["Small pipes", "Small pipes and leaks"], "correct": 1, "explanation": "Undersized pipes and leaks reduce efficiency."},
      {"question": "Who may repair compressed air equipment?", "options": ["Any artisan", "Competent person"], "correct": 1, "explanation": "Requires competent person per regulations."},
      {"question": "Purpose of air dryer?", "options": ["Remove moisture", "Increase volume"], "correct": 0, "explanation": "Prevents water in system."},
      {"question": "Maximum allowable leak rate?", "options": ["5%", "10%"], "correct": 1, "explanation": "Typical target <10% leakage."},
      {"question": "What indicates compressor overload?", "options": ["High temperature", "High temperature and low pressure"], "correct": 1, "explanation": "Overheating and pressure drop."},
      {"question": "Minimum distance from compressor to receiver?", "options": ["1 m", "3 m"], "correct": 1, "explanation": "Minimum 3 m for cooling."},
      {"question": "Purpose of automatic drain trap?", "options": ["Remove condensate", "Remove condensate and save energy"], "correct": 1, "explanation": "Removes water automatically."},
      {"question": "What protects against air line whip?", "options": ["Whipcheck cables", "Whipcheck cables and strong clamps"], "correct": 1, "explanation": "Prevents hose whipping if disconnected."},
      {"question": "Standard pressure for rock drills?", "options": ["400 kPa", "600 kPa"], "correct": 1, "explanation": "Typically 600 kPa for pneumatic drills."},
      {"question": "What must be recorded for air receivers?", "options": ["Inspection dates", "Inspection dates and test pressures"], "correct": 1, "explanation": "Full history in register."},
      {"question": "Maximum temperature for compressed air discharge?", "options": ["60 °C", "80 °C"], "correct": 1, "explanation": "Typically limited to 80 °C."}
    ]},

  pump_fluid: {name: "Pump and Fluid handling",q:[
      {"question": "Main cause of cavitation in centrifugal pumps?", "options": ["High discharge", "NPSHa < NPSHr"], "correct": 1, "explanation": "Net Positive Suction Head insufficient."},
      {"question": "Device to prevent dry running?", "options": ["Pressure switch", "Low level/float switch"], "correct": 1, "explanation": "Protects pump from no-flow damage."},
      {"question": "Purpose of foot valve in sump pumps?", "options": ["Prevent backflow/keep prime", "Increase pressure"], "correct": 0, "explanation": "Maintains suction prime."},
      {"question": "Minimum inspection frequency for dewatering pumps?", "options": ["Daily", "Weekly"], "correct": 0, "explanation": "Daily checks per mine regulations."},
      {"question": "What indicates worn pump impeller?", "options": ["Reduced flow/head", "Reduced flow/head and vibration"], "correct": 1, "explanation": "Erosion reduces performance."},
      {"question": "Purpose of gland packing?", "options": ["Seal shaft", "Seal shaft and cool shaft"], "correct": 1, "explanation": "Seals and cools."},
      {"question": "What is 'pump priming'?", "options": ["Filling with fluid", "Increasing speed"], "correct": 0, "explanation": "Removing air for suction."},
      {"question": "Maximum suction lift for centrifugal pumps?", "options": ["6 m", "8 m"], "correct": 1, "explanation": "Approximately 8 m theoretical max."},
      {"question": "Purpose of non-return valve?", "options": ["Prevent reverse flow", "Increase pressure"], "correct": 0, "explanation": "Stops backflow on shutdown."},
      {"question": "What causes seal failure?", "options": ["Dry running", "Dry running and abrasion"], "correct": 1, "explanation": "Common causes of mechanical seal damage."},
      {"question": "Minimum NPSH margin recommended?", "options": ["1 m", "2 m"], "correct": 1, "explanation": "2 m safety margin typical."},
      {"question": "Purpose of strainer on suction line?", "options": ["Prevent debris entry", "Increase flow"], "correct": 0, "explanation": "Protects impeller."},
      {"question": "What is 'vapour locking'?", "options": ["Air in pump", "Air in pump and vapour bubbles"], "correct": 1, "explanation": "Vapour blocks suction."},
      {"question": "Typical material for acid-resistant pumps?", "options": ["Cast iron", "Stainless steel"], "correct": 1, "explanation": "SS for corrosive fluids."},
      {"question": "Purpose of balance drum in multistage pump?", "options": ["Reduce axial thrust", "Increase pressure"], "correct": 0, "explanation": "Balances thrust forces."},
      {"question": "What indicates bearing failure?", "options": ["Noise", "Noise and high temperature"], "correct": 1, "explanation": "Early warning signs."},
      {"question": "Minimum flow through pump?", "options": ["Zero", "30% of BEP"], "correct": 1, "explanation": "Minimum flow to prevent overheating."},
      {"question": "Purpose of pump curve?", "options": ["Show performance", "Show performance and calculate power"], "correct": 1, "explanation": "Head, flow, efficiency, power."},
      {"question": "What causes pump recirculation?", "options": ["Low flow", "High flow"], "correct": 0, "explanation": "Occurs at low flow rates."},
      {"question": "Who may repair critical pumps?", "options": ["Any artisan", "Competent person"], "correct": 1, "explanation": "Requires competent person."},
      {"question": "Purpose of lantern ring?", "options": ["Distribute flush water", "Distribute flush water and reduce leakage"], "correct": 1, "explanation": "Cooling and sealing."},
      {"question": "Maximum temperature for standard centrifugal pump?", "options": ["80 °C", "120 °C"], "correct": 1, "explanation": "Typically 120 °C without cooling."},
      {"question": "What is 'specific speed'?", "options": ["Pump classification", "Efficiency measure"], "correct": 0, "explanation": "Characterises impeller type."},
      {"question": "Purpose of vent valve on pump casing?", "options": ["Remove air", "Increase pressure"], "correct": 0, "explanation": "For priming."},
      {"question": "Minimum clearance for gland adjustment?", "options": ["0.5 mm", "1 mm"], "correct": 1, "explanation": "Typical 1 mm drip rate."}
    ]},

  lifting_operations: {name: "Lifting Operations", q: [
      {"question": "What is the statutory factor of safety (FOS) for chain slings used for general lifting?", "options": ["4:1", "5:1"], "correct": 1, "explanation": "Driven Machinery Regulations require 5:1 minimum for chain slings."},
      {"question": "Who must personally inspect lifting tackle before each use?", "options": ["Operator", "Appointed lifting machinery inspector"], "correct": 1, "explanation": "The appointed competent person must inspect and tag."},
      {"question": "What colour tag shows lifting tackle is currently safe?", "options": ["Red", "Green"], "correct": 1, "explanation": "Green = inspected and safe; red = defective/out of service."},
      {"question": "Maximum allowable wear on a chain link before discard?", "options": ["5%", "10%"], "correct": 1, "explanation": "10% reduction in diameter is the statutory limit."},
      {"question": "Synthetic fibre slings should not be used at angles greater than?", "options": ["45°", "60°"], "correct": 1, "explanation": "Capacity drops dramatically above 60° from vertical."},
      {"question": "What marking must appear on a wire rope sling thimble?", "options": ["SWL only", "Manufacturer, size, date and SWL"], "correct": 1, "explanation": "Full traceability markings are required."},
      {"question": "How often must lifting tackle be thoroughly examined?", "options": ["Monthly", "Every 3 months"], "correct": 1, "explanation": "Every 3 months or after any incident."},
      {"question": "What is the purpose of a bow shackle keeper pin?", "options": ["Prevent unscrewing", "Increase strength"], "correct": 0, "explanation": "Safety pin/bolt prevents accidental opening."},
      {"question": "Which lifting machine requires a load-radius chart?", "options": ["Overhead crane", "Mobile crane"], "correct": 1, "explanation": "Mobile cranes must display rated capacity at different radii."},
      {"question": "What must be done if a chain link is elongated?", "options": ["Use until next inspection", "Discard immediately"], "correct": 1, "explanation": "Elongation indicates plastic deformation – discard."},
      {"question": "Minimum FOS for man-riding tackle?", "options": ["8:1", "10:1"], "correct": 1, "explanation": "10:1 is required for personnel lifting."},
      {"question": "Who issues a permit to use defective lifting tackle?", "options": ["No one", "Chief inspector"], "correct": 0, "explanation": "Defective tackle may never be used."},
      {"question": "What is the correct way to store synthetic slings?", "options": ["In sunlight", "In cool, dry, dark place"], "correct": 1, "explanation": "UV and heat degrade synthetic materials."},
      {"question": "What indicates a wire rope must be discarded?", "options": ["6 broken wires in one lay", "Visible rust only"], "correct": 0, "explanation": "Broken wires in one lay length is a discard criterion."},
      {"question": "What is the purpose of a spreader beam?", "options": ["Increase lifting height", "Reduce sling angle stress"], "correct": 1, "explanation": "Maintains vertical sling legs to maximise capacity."},
      {"question": "How should a load be lifted off the ground?", "options": ["Quick jerk", "Slow and steady"], "correct": 1, "explanation": "Sudden jerks cause shock loading."},
      {"question": "What device prevents load swing on a crane?", "options": ["Tag line", "Anti-two-block"], "correct": 0, "explanation": "Tag lines control swing during travel."},
      {"question": "Who may operate a mobile crane?", "options": ["Any driver", "Person with valid certificate"], "correct": 1, "explanation": "Driven Machinery Regulations require competency certificate."},
      {"question": "What is the maximum wind speed for safe crane operation?", "options": ["10 m/s", "15 m/s"], "correct": 1, "explanation": "Typically 15 m/s (54 km/h) is the safe limit."},
      {"question": "What must be done before lifting personnel?", "options": ["Use man basket only", "Use any cage"], "correct": 0, "explanation": "Approved man-riding basket/cage required."},
      {"question": "Purpose of load test on new lifting tackle?", "options": ["Prove strength", "Check appearance"], "correct": 0, "explanation": "125% proof load test required before first use."},
      {"question": "What is a 'soft eye' on a sling?", "options": ["Thimble protected", "No thimble"], "correct": 1, "explanation": "Soft eye = unprotected loop, lower capacity."},
      {"question": "Minimum age to operate lifting machinery?", "options": ["16", "18"], "correct": 1, "explanation": "18 years minimum per DMR."},
      {"question": "What indicates overloading of a sling?", "options": ["Permanent elongation", "Colour change"], "correct": 0, "explanation": "Permanent stretch = overload – discard."},
      {"question": "Who keeps records of lifting tackle inspections?", "options": ["Operator", "Appointed person"], "correct": 1, "explanation": "Appointed competent person maintains register."}
    ]},

  civil_structural: {name: "Civil and Structural Engineering",q: [
      {"question": "Purpose of movement joints in concrete structures?", "options": ["Increase strength", "Allow thermal expansion/shrinkage"], "correct": 1, "explanation": "Prevents uncontrolled cracking from temperature and shrinkage."},
      {"question": "Minimum concrete cover for severe exposure (SANS 10400)?", "options": ["25 mm", "50 mm"], "correct": 1, "explanation": "50 mm required in severe conditions to protect rebar."},
      {"question": "Why are construction joints planned in large pours?", "options": ["Aesthetic", "Control cracking and allow phasing"], "correct": 1, "explanation": "Manage heat and shrinkage cracking."},
      {"question": "Most common field test for concrete workability?", "options": ["Compressive test", "Slump test"], "correct": 1, "explanation": "Slump test measures consistency."},
      {"question": "Typical minimum grade for structural columns?", "options": ["C25/30", "C30/37"], "correct": 1, "explanation": "C30/37 commonly specified for columns."},
      {"question": "What causes concrete spalling?", "options": ["Too much water", "Corrosion of reinforcement"], "correct": 1, "explanation": "Rust expansion cracks cover concrete."},
      {"question": "Purpose of shear reinforcement in beams?", "options": ["Increase bending strength", "Resist diagonal tension"], "correct": 1, "explanation": "Stirrups resist shear failure."},
      {"question": "Minimum curing time for structural concrete?", "options": ["3 days", "7 days"], "correct": 1, "explanation": "7 days minimum for most structural elements."},
      {"question": "What is the slump range for pumped concrete?", "options": ["75–100 mm", "100–150 mm"], "correct": 1, "explanation": "Higher slump (100–150 mm) required for pumping."},
      {"question": "Maximum allowable crack width in water-retaining structures?", "options": ["0.1 mm", "0.2 mm"], "correct": 1, "explanation": "0.2 mm typical limit to prevent leakage."},
      {"question": "Purpose of expansion joints in long buildings?", "options": ["Allow movement due to temperature", "Increase load capacity"], "correct": 0, "explanation": "Prevent stress from thermal expansion."},
      {"question": "What test measures compressive strength?", "options": ["Slump", "Cube test"], "correct": 1, "explanation": "150 mm cubes crushed at 28 days."},
      {"question": "Minimum grade for foundations in aggressive soil?", "options": ["C30/37", "C40/50"], "correct": 1, "explanation": "Higher grade for durability in sulphate soils."},
      {"question": "What is 'bleeding' in concrete?", "options": ["Excess water rising", "Cracking"], "correct": 0, "explanation": "Excess water migrates to surface."},
      {"question": "Purpose of formwork ties?", "options": ["Hold forms together", "Reinforce concrete"], "correct": 0, "explanation": "Resist concrete pressure."},
      {"question": "Maximum aggregate size for columns?", "options": ["10 mm", "20 mm"], "correct": 1, "explanation": "20 mm typical to avoid congestion."},
      {"question": "What indicates poor compaction?", "options": ["Honeycombing", "Smooth finish"], "correct": 0, "explanation": "Voids from inadequate vibration."},
      {"question": "Minimum lap length for rebar (SANS)?", "options": ["30 × diameter", "40 × diameter"], "correct": 1, "explanation": "Typically 40d for tension laps."},
      {"question": "Purpose of waterstops in joints?", "options": ["Prevent water leakage", "Increase strength"], "correct": 0, "explanation": "Seal construction joints in water tanks."},
      {"question": "What is 'carbonation'?", "options": ["Chloride attack", "CO₂ reduces alkalinity"], "correct": 1, "explanation": "Lowers pH, initiates rebar corrosion."},
      {"question": "Minimum concrete temperature for placing?", "options": ["0 °C", "5 °C"], "correct": 1, "explanation": "5 °C minimum to prevent freezing."},
      {"question": "What causes honeycombing?", "options": ["Poor vibration", "Too much water"], "correct": 0, "explanation": "Inadequate consolidation."},
      {"question": "Purpose of construction sequence planning?", "options": ["Speed up work", "Control shrinkage stresses"], "correct": 1, "explanation": "Phased pours reduce restraint cracking."},
      {"question": "Maximum w/c ratio for durability?", "options": ["0.40", "0.50"], "correct": 1, "explanation": "0.50 maximum for most structural concrete."},
      {"question": "Who approves concrete mix design?", "options": ["Contractor", "Engineer"], "correct": 1, "explanation": "Structural engineer approves."}
    ]},

  conveyor_monorail: {name: "Conveyor Belt and Monorail",q: [
      {"question": "What is the statutory requirement for guarding conveyor nip points?", "options": ["Optional", "Fixed guards where accessible"], "correct": 1, "explanation": "DMR Regulation 8 mandates secure guarding of all nip points."},
      {"question": "Device required to prevent run-back on inclined conveyors?", "options": ["Anti-runback idler", "Backstop or holdback"], "correct": 1, "explanation": "Backstop prevents reverse movement during power failure."},
      {"question": "Maximum allowable sag between idlers on loaded belt?", "options": ["1%", "2.5%"], "correct": 1, "explanation": "Sag >2.5% causes spillage and high power use."},
      {"question": "Minimum FOS for monorail load chain/rope?", "options": ["5:1", "6:1"], "correct": 1, "explanation": "DMR requires 6:1 for monorail hoisting elements."},
      {"question": "Immediate action on longitudinal belt tear?", "options": ["Continue slowly", "Stop and isolate"], "correct": 1, "explanation": "Immediate stop prevents catastrophic failure."},
      {"question": "What must be installed at conveyor transfer points?", "options": ["Skirt boards and seals", "Extra idlers only"], "correct": 0, "explanation": "Skirts reduce spillage and dust."},
      {"question": "Purpose of belt training idlers?", "options": ["Increase speed", "Keep belt centred"], "correct": 1, "explanation": "Self-aligning idlers correct belt tracking."},
      {"question": "Maximum permissible belt speed in underground mines?", "options": ["3 m/s", "4 m/s"], "correct": 1, "explanation": "Typically limited to 4 m/s for safety."},
      {"question": "What device detects belt slip?", "options": ["Slip switch", "Load cell"], "correct": 0, "explanation": "Slip switch trips on excessive pulley-belt slip."},
      {"question": "Minimum clearance under conveyor belt?", "options": ["500 mm", "750 mm"], "correct": 1, "explanation": "750 mm minimum for safe crossing/maintenance."},
      {"question": "What colour coding is used for conveyor emergency stop cords?", "options": ["Red", "Yellow"], "correct": 0, "explanation": "Red pull-cords are standard for emergency stops."},
      {"question": "Purpose of take-up device on conveyor?", "options": ["Adjust belt tension", "Adjust belt tension and reduce sag"], "correct": 1, "explanation": "Maintains proper tension and controls sag."},
      {"question": "How often must conveyor belt splices be inspected?", "options": ["Daily", "Weekly"], "correct": 0, "explanation": "Daily visual checks required for splices."},
      {"question": "What indicates a worn drive pulley lagging?", "options": ["Belt slip", "Belt slip, noise increase and vibration"], "correct": 1, "explanation": "Poor lagging causes slip, noise and vibration."},
      {"question": "Minimum distance between conveyor and walkway?", "options": ["500 mm", "750 mm"], "correct": 1, "explanation": "750 mm clearance for safe access."},
      {"question": "What protects against belt tear propagation?", "options": ["Rip detectors", "Edge sensors"], "correct": 0, "explanation": "Rip detectors stop belt on longitudinal tear."},
      {"question": "Purpose of impact idlers at loading points?", "options": ["Absorb shock", "Increase speed"], "correct": 0, "explanation": "Cushion heavy material drop impact."},
      {"question": "Who may operate a monorail locomotive?", "options": ["Any person", "Competent certificate holder"], "correct": 1, "explanation": "Requires valid competency certificate."},
      {"question": "What is mandatory on monorail tracks?", "options": ["Derailment prevention", "Derailment prevention and speed limit signs"], "correct": 1, "explanation": "Derailment guards and signage required."},
      {"question": "Maximum gradient for monorail track?", "options": ["1:10", "1:20"], "correct": 1, "explanation": "Typically 1:20 maximum for safe operation."},
      {"question": "What must be done before conveyor maintenance?", "options": ["Lockout/tagout", "Speed reduction only"], "correct": 0, "explanation": "Full LOTO required for safety."},
      {"question": "Purpose of belt weigher?", "options": ["Measure tonnage", "Measure tonnage and detect overload"], "correct": 1, "explanation": "Continuous mass measurement."},
      {"question": "What indicates misalignment?", "options": ["Edge wear", "Edge wear and spillage"], "correct": 1, "explanation": "Misalignment causes edge damage and spillage."},
      {"question": "Minimum pulley diameter ratio to belt thickness?", "options": ["100:1", "150:1"], "correct": 1, "explanation": "Typical minimum 150:1 for bend fatigue."},
      {"question": "Emergency stop pull cord spacing?", "options": ["Every 10 m", "Every 30 m"], "correct": 1, "explanation": "Maximum 30 m spacing per regulations."}
    ]},

 steam_pressure: {name: "Steam Generations and Pressure Vessels",q: [
      {"question": "Who is legally responsible for safe boiler operation?", "options": ["Operator", "Appointed competent person"], "correct": 1, "explanation": "PER requires appointed competent person."},
      {"question": "Minimum frequency for internal inspection of steam receiver?", "options": ["12 months", "36 months"], "correct": 1, "explanation": "36 months per Pressure Equipment Regulations."},
      {"question": "Mandatory device to prevent boiler overpressure?", "options": ["Pressure gauge", "Safety valve"], "correct": 1, "explanation": "Safety valve is essential."},
      {"question": "Procedure before entering pressure vessel?", "options": ["Permit-to-work + isolation", "Drain only"], "correct": 0, "explanation": "Full PTW and gas-free required."},
      {"question": "Purpose of boiler blowdown?", "options": ["Remove sludge/TDS", "Increase pressure"], "correct": 0, "explanation": "Controls scaling and corrosion."},
      {"question": "What indicates low water in boiler?", "options": ["Low level alarm", "High steam pressure"], "correct": 0, "explanation": "Critical safety alarm."},
      {"question": "Minimum water level gauge requirement?", "options": ["One", "Two independent"], "correct": 1, "explanation": "Two independent gauges mandatory."},
      {"question": "Purpose of superheater?", "options": ["Increase steam temperature", "Reduce pressure"], "correct": 0, "explanation": "Produces dry superheated steam."},
      {"question": "What is 'carryover' in boilers?", "options": ["Water in steam", "Steam in water"], "correct": 0, "explanation": "Contaminates steam system."},
      {"question": "Maximum allowable TDS in boiler water?", "options": ["2000 ppm", "Depends on boiler"], "correct": 1, "explanation": "Controlled by blowdown."},
      {"question": "Purpose of economiser?", "options": ["Preheat feedwater", "Superheat steam"], "correct": 0, "explanation": "Recovers heat from flue gas."},
      {"question": "Who may operate a steam boiler?", "options": ["Any person", "Boiler attendant certificate holder"], "correct": 1, "explanation": "Requires valid certificate."},
      {"question": "What protects against furnace explosion?", "options": ["Flame scanner", "Flame scanner and purge cycle"], "correct": 1, "explanation": "Prevents fuel accumulation."},
      {"question": "Minimum pressure test frequency for boilers?", "options": ["Annually", "After repair"], "correct": 1, "explanation": "After major repair or as required."},
      {"question": "Purpose of fusible plug?", "options": ["Low water protection", "Overpressure"], "correct": 0, "explanation": "Melts on low water exposure."},
      {"question": "What is 'priming' in boilers?", "options": ["Sudden water carryover", "Slow steam rise"], "correct": 0, "explanation": "Caused by high water level."},
      {"question": "Material for high-pressure steam pipes?", "options": ["Mild steel", "Carbon steel"], "correct": 1, "explanation": "Carbon steel standard for high temp."},
      {"question": "Purpose of steam trap?", "options": ["Remove condensate", "Remove condensate and allow steam pass"], "correct": 1, "explanation": "Efficient condensate removal."},
      {"question": "What indicates scale buildup?", "options": ["High fuel use", "High fuel use and overheating tubes"], "correct": 1, "explanation": "Reduces heat transfer."},
      {"question": "Minimum safety valve capacity?", "options": ["Evaporation rate", "1.5 × evaporation"], "correct": 1, "explanation": "Must exceed boiler capacity."},
      {"question": "Who approves boiler repairs?", "options": ["Operator", "Authorized inspector"], "correct": 1, "explanation": "Authorized person required."},
      {"question": "Purpose of feedwater treatment?", "options": ["Remove oxygen/scale", "Remove oxygen/scale and increase pH"], "correct": 1, "explanation": "Prevents corrosion and scaling."},
      {"question": "Maximum allowable CO in boiler flue?", "options": ["100 ppm", "200 ppm"], "correct": 1, "explanation": "Typical limit for efficiency/safety."},
      {"question": "What is 'water hammer'?", "options": ["Sudden pressure surge", "Slow flow"], "correct": 0, "explanation": "Caused by condensate slugs."},
      {"question": "Minimum logbook entries for boiler?", "options": ["Pressure, water level, blowdown", "Only pressure"], "correct": 0, "explanation": "Full operating parameters."}
    ]}, 
...
const moduleDescriptions = {
    handover: "Shift handover and pre-shift checks ensure seamless, safe operations by bridging information gaps between teams.\n\nDetailed requirements:\n- Formal handover protocol: Documented exchange of equipment status, defects, hazards (e.g., geotechnical instability, gas levels, ventilation issues), ongoing maintenance, production updates, incidents/near-misses, and any permit or procedure changes.\n- Inspection and documentation: Statutory checks (daily for high-risk machinery, weekly/monthly for others), declarations of fitness for duty/equipment, comprehensive defect logbooks with timestamps and signatures, early morning examinations for critical plant like winders or fans.\n- MHSA compliance: Aligns with Chapter 2 (employer duties on risk management, safe systems) and Chapter 8 (Machinery & Equipment – e.g., pre-start checks, lock-outs), emphasizing risk assessments to prevent miscommunication-led accidents.\n- Practical tips: Use standardized digital checklists for traceability, include verbal walkthroughs, and train on handover COPs to reduce shift-start errors.",

    lhd: "LHD tramming in declines mandates advanced safety under MHSA Chapter 8 Reg 8.10 (TMM regulations, 2015 amendment; fail-to-safe collision systems enforced ~2022).\n\nCore controls and insights:\n- Pre-operational inspections: Thorough checks of braking systems (service, park, emergency – must be fail-safe), lighting/horns/reflectors, automatic fire suppression activation, hydraulic integrity, tyre condition/pressures, visibility aids like cameras/mirrors – all logged daily.\n- Operational practices: Gradient-specific controls (e.g., no free-wheeling, use of retarders), load limits to prevent tipping, speed restrictions based on decline angle/road conditions.\n- Hazard mitigation: Pedestrian exclusion zones with barriers, radio-based traffic coordination, automatic fire extinguishers for engine/hot surfaces.\n- Collision avoidance: Mandatory proximity detection (pedestrian/machine warnings, speed retardation, full auto-braking without operator input per Reg 8.10.1.2(b)), machine-to-machine interfacing in congested areas.\n- Additional: Runaway prevention via incline-specific brakes, rollover protective structures (ROPS) if risk-assessed; integrates with SAMRASS reporting for any incidents.\n- Why critical: TMM incidents account for ~30% of mine fatalities – prioritize engineering controls like auto-braking over reliance on operator vigilance.",

    drill: "Face drilling with jumbo rigs (hydraulic/pneumatic) requires precise safety measures under MHSA Chapter 8 Reg 8.8 (general machinery safeguards).\n\nExpanded elements:\n- Competency and setup: Certified operator training on rig controls/stability; mandatory dust suppression (wet methods, vacuum extractors) to comply with occupational exposure limits (OELs) for silica dust.\n- Pre-drilling protocols: Install temporary roof/rib support; conduct detailed face examinations for fractures, water ingress, or unstable strata using barring tools.\n- Drilling execution: Accurate hole patterning/marking to optimize blast efficiency and minimize misfires; collaring techniques to ensure alignment/depth control.\n- Safety features: Full guarding of rotating drill steels/rods, interlocked barriers, lock-out/tag-out during maintenance, pre-start audible/visual warnings (minimum 10-second delay per site risk assessment).\n- Emergency and compliance: Accessible emergency stops, no loose attire near moving parts; links to explosives regs for safe proximity; report any drill-related incidents via SAMRASS.\n- Learning point: Inadequate support or poor patterning often causes flyrock or ground failure – regular audits essential.",

    support: "Installation of support systems (mesh, bolts, cables, shotcrete) is guided by rock engineering to counter ground instability.\n\nDetailed practices:\n- System selection: Temporary (e.g., friction bolts, split sets) for immediate stability vs. permanent (grouted rock bolts, mesh reinforcement) based on geotechnical strata analysis.\n- Installation techniques: Precise drilling depths, bolt torque/tensioning to manufacturer specs, resin/grout mixing/curing, washer/plate securing for load distribution.\n- Quality assurance: Routine pull testing (e.g., 10-20% of installations to verify holding capacity), corrosion protection (galvanized coatings in wet environments), density mapping per rock quality designation (RQD).\n- Advanced applications: Yielding/dynamic bolts in seismic-prone areas to absorb energy; ongoing monitoring with extensometers or visual inspections.\n- MHSA alignment: Complies with geotechnical regulations (Chapter 16 equivalent) and Chapter 8 for machinery used in installation; incident reporting through SAMRASS if failures occur.\n- Risk focus: Falls of ground (FOG) are a leading hazard – integrate with site COPs for proactive re-support.",

    vent: "Main ventilation failure procedures are vital under MHSA Chapter 9 (environmental engineering) and emergency regulations.\n\nStep-by-step response:\n- Immediate actions: Fan failure alarms trigger evacuation to designated fresh air bases or refuge bays; all personnel don self-contained self-rescuers (SCSRs) for at least 30-60 minutes of breathable air.\n- Refuge protocols: Bays equipped with compressed air lines, CO2 scrubbers, potable water, communications (telephones/leaky feeders), and sustainment for 36-96 hours depending on mine depth.\n- Recovery phase: Post-fan restart, conduct multi-point gas monitoring (methane <1%, CO <50ppm, O2 >19.5%, NOx/dust levels); stepwise re-entry with competent supervision and barring of loose ground.\n- Reporting and drills: Log incidents via SAMRASS (immediate for serious events); mandatory quarterly evacuation drills to test response times.\n- Integration: Links to overall emergency preparedness COPs; prevents asphyxiation/explosions by ensuring auxiliary ventilation backups.",

    rockfall: "Major rock fall event management prioritizes prevention and rapid response to falls of ground (FOG).\n\nComprehensive strategies:\n- Risk identification: Geotechnical assessments including seismic monitoring, stress mapping, and daily face/ground inspections for precursors like cracking or spalling.\n- Preventive measures: Proactive scaling/barring-down using mechanized scalers or hand tools; installation of additional supports like nets or straps in high-risk zones.\n- Post-event protocols: Immediate area evacuation/barricading; re-entry only after waiting periods (e.g., 4-8 hours), gas clearance, and re-inspection by rock engineer.\n- Investigation: Root-cause analysis (e.g., blasting-induced or natural), SAMRASS reporting for fatalities/injuries, and updates to ground control COPs.\n- MHSA compliance: Aligns with geotechnical regs and Chapter 8 for safe equipment use in response; emphasizes hierarchy of controls (eliminate via design, then engineer supports).",

    traffic: "Single-lane traffic management for TMM under MHSA Chapter 8 Reg 8.10 minimizes conflicts in confined spaces.\n\nKey controls:\n- Planning: Develop site-specific traffic management COPs with one-way circuits, designated passing bays equipped with visibility aids (mirrors, lights, sensors).\n- Rules enforcement: Clear priorities (e.g., loaded vehicles uphill), speed limits tailored to road width/gradient (e.g., <20km/h in singles), pedestrian-free zones with physical barriers.\n- Communication: Mandatory two-way radios for coordination, proximity alerts integrated with collision systems.\n- Monitoring: Fleet tracking via GPS/dispatch centers; incident logging through SAMRASS for any collisions.\n- Risk reduction: Enhanced lighting/signage, training on right-of-way; prevents ~20% of TMM-related incidents in narrow haulages.",

    reentry: "Unsafe re-entry prevention after blasting follows MHSA explosives regulations (Chapter 21 equivalent) and ventilation standards.\n\nStructured protocols:\n- Waiting periods: Minimum ventilation times (e.g., 30-60 minutes) for fume dispersal based on blast size/airflow rates.\n- Testing: Systematic multi-gas detection (NOx <25ppm, CO <50ppm, SO2 <2ppm) using calibrated instruments; check for irrespirable zones.\n- Misfire handling: Visual inspection for unexploded charges; safe disposal methods (re-firing or water flushing) by certified blasters.\n- Re-examination: Full face/ground assessment for instability, flyrock remnants; only authorized entry post-clearance.\n- Reporting: SAMRASS submission for any misfires or fume incidents; integrates with Chapter 8 for machinery re-start safety.\n- Emphasis: Toxic fumes cause acute health issues – rigorous testing mandatory.",

    shaft_sinking: "Vertical shaft sinking is regulated under MHSA Chapter 8 Reg 8.13 (2025 amendments via GN 6054/52388 and GN 6267/52781, repealing Minerals Act Chapter 16).\n\nOperational details:\n- Methods: Controlled drill-blast-muck cycles or raise-boring; equipping with steel sets, guides, piping for services.\n- Safety systems: Overwind/underspeed protection on hoists, automatic shaft gates/doors, falling object arrestors.\n- Hoisting: Kibble or stage management with load limits; emergency man-riding/escape ladders or capsules.\n- Personnel: Competency certification for banksman (surface signaling), onsetter (underground loading), and winder drivers; training on emergency signals.\n- Compliance: Design approvals by DMRE, daily inspections/records, SAMRASS reporting for incidents like inrushes or falls; focuses on preventing catastrophic hoisting failures.",

    raise_drill: "Raise drilling (boring) for vertical/inclined raises adheres to MHSA Chapter 8 Reg 8.8 general machinery rules.\n\nSafety breakdown:\n- Setup: Secure machine anchoring on stable platforms; pilot hole drilling with laser-guided alignment surveys to prevent deviation.\n- Reaming: Controlled upward/downward reaming with efficient cuttings removal via mud/flushing systems.\n- Monitoring: Remote operation/video feeds for hazardous zones; real-time dust/fume extraction to meet OELs.\n- Protections: Exclusion zones around rotating components, full guarding of drill strings/rods, lock-out/tag-out for maintenance/changes.\n- Incident management: SAMRASS reporting for any collapses or entanglements; emphasizes precision to avoid costly re-drills.",

    lifting_operations: "Lifting operations (cranes, forklifts) are governed by MHSA Chapter 8 Reg 8.5 (lifting equipment and tackle).\n\nRigorous standards:\n- Inspections: Daily pre-use checks of wires, hooks, slings, limit switches; statutory thorough examinations every 6-12 months with proof load testing.\n- Planning: Competent rigger develops lift plans including weight estimates, center of gravity, wind/ground stability factors, sling configurations.\n- Execution: Use of tag lines for load control, exclusion zones below lifts, standardized hand/radio signals.\n- Compliance: Safe working load (SWL) markings, factors of safety (e.g., 5:1 for wire ropes); SAMRASS for dropped load incidents.\n- Focus: Prevents structural failures – mandatory for all surface/underground handling.",

    civil_structural: "Civil and structural engineering maintains mine infrastructure integrity under MHSA structural regulations.\n\nKey aspects:\n- Design: Engineer approvals for load-bearing elements (e.g., headgears, dams) considering seismic/ground loads.\n- Construction: Quality controls like concrete compressive testing, steel welding NDT (non-destructive testing).\n- Maintenance: Corrosion protection (e.g., epoxy, cathodic); periodic inspections (visual, ultrasonic) every 1-5 years.\n- Monitoring: Strain gauges for deformation; SAMRASS reporting for collapses.\n- Compliance: Ensures resilience against environmental degradation or overloading.",

    conveyor_monorail: "Conveyor belt and monorail systems fall under MHSA Chapter 8 general machinery and materials handling regs.\n\nControls:\n- Installation: Proper belt alignment/tensioning, idler spacing; guarding at all pinch points/tail ends.\n- Operation: Emergency pull-cords along entire length, automatic fire detection/suppression (e.g., infrared sensors, water deluge).\n- Maintenance: Splicing to SANS standards, idler/bearing replacements; lock-out/tag-out procedures.\n- Special: Man-riding rules (speed <2.5m/s, emergency stops); spillage controls with scrapers.\n- Reporting: SAMRASS for fires/entanglements; prevents belt-related incidents.",

    compressed_air: "Compressed air reticulation under MHSA Chapter 8 Reg 8.1 (compressors and pressure vessels).\n\nEssentials:\n- Operation: Interlocked compressors with auto-shutdowns, pressure relief valves set to 110% of max.\n- Inspections: Statutory internal/external exams of receivers (every 24-36 months), thickness gauging.\n- Distribution: Leak detection programs, pressure-regulated reticulation; hose fittings with whip restraints/safety clips.\n- Safety: Lock-out for repairs; SAMRASS for bursts/explosions.\n- Risk: High-pressure hazards – mandatory training.",

    pump_fluid: "Pump and fluid handling systems under MHSA Chapter 8 general machinery regulations.\n\nDetails:\n- Selection/Maintenance: Multistage pumps for high-head dewatering, submersibles for sumps; routine impeller/seal checks.\n- Systems: Pipeline integrity testing (pressure/hydro), sump auto-level controls with flood alarms.\n- Treatment: Water neutralization/settling to prevent corrosion; sludge handling with safe disposal.\n- Protections: Guarding on rotating shafts/couplings, lock-out procedures.\n- Compliance: SAMRASS for flooding incidents; critical in wet mines to avoid inundations.",

    steam_pressure: "Steam generation and pressure vessels linked to MHSA Chapter 8 pressure equipment rules.\n\nProtocols:\n- Operation: Boiler feedwater treatment, low-water cut-offs, pressure/temperature monitoring.\n- Safety devices: Dual safety valves (tested quarterly), blowdown valves for sediment removal.\n- Inspections: Statutory exams (internal every 24 months), calibration of gauges.\n- Maintenance: Scheduled shutdowns for cleaning; SAMRASS for ruptures/explosions.\n- Focus: Scalding/explosion prevention in surface plants.",

    electrical: "Underground electrical systems safety under MHSA Chapter 3 (electrical installations) cross-referenced with Chapter 8 guarding.\n\nFeatures:\n- Equipment: Flameproof enclosures in gassy areas, intrinsically safe circuits for instruments.\n- Protections: Earth leakage relays (<500mA trip), overload/short-circuit devices.\n- Maintenance: Cable insulation testing, switchgear/transformer bunding for oil leaks.\n- Procedures: Lockout/tagout for isolations; SAMRASS for shocks/arcs.\n- Hazard: Ignition risks in methane-prone zones – rigorous compliance essential.",

    mhsa: "The Mine Health and Safety Act 1996 (MHSA) and Regulations form South Africa's comprehensive legal framework for zero-harm mining.\n\nExpanded overview:\n- Core duties: Employers conduct baseline/ongoing risk assessments, provide training/PPE, develop mandatory Codes of Practice (COPs) for high-risk areas like TMM or falls of ground.\n- Employee rights: Right to refuse dangerous work, access to health/safety info, participation in tripartite committees (mine, regional, national).\n- Structures: Mine Health and Safety Council (MHSC) advises on policy; tripartite forums for stakeholder input.\n- Incident reporting via SAMRASS (South African Mines Reportable Accidents Statistical System): Mandatory electronic submission within specified timelines (e.g., immediate for fatalities, 7 days for reportables); covers accidents, dangerous occurrences, occupational diseases; data used for national statistics, trend analysis, and DMRE investigations.\n- Enforcement: DMRE inspectors have stop-work powers, issue prohibitions/notices; penalties up to R3 million or imprisonment for non-compliance.\n- Continuous improvement: Annual health/safety programs, audits; covers all chapters from occupational health (Ch 11) to explosives (Ch 21).",

    seismicity: "Seismicity and rockbursts management in high-stress/deep-level mining under MHSA geotechnical regulations.\n\nStrategies:\n- Monitoring: Real-time seismic networks with event localization, magnitude calculation, aftershock predictions.\n- Analysis: Rock mass stress modeling using numerical software; identification of burst-prone zones.\n- Controls: Energy-absorbing support (e.g., cone bolts, mesh straps); de-stressing techniques like preconditioning blasts.\n- Protocols: Automated warning systems, exclusion periods post-events, controlled re-entry with inspections.\n- Reporting: SAMRASS for bursts causing injury/damage; integrates with COPs for seismic risk.",

    blasting: "Blasting and explosives handling under MHSA explosives regulations (linked to Chapter 8 machinery).\n\nDetailed processes:\n- Design: Optimized patterns (burden, spacing, delays) for fragmentation while controlling vibration/flyrock.\n- Handling: Secure storage/magazines, charging with approved primers/boosters, electronic initiation for precision.\n- Safety: Misfire procedures (wait 30 mins, then inspect/dispose); fume management via ventilation modeling.\n- Controls: Perimeter guarding, siren warnings, post-blast inspections.\n- Compliance: Blaster certification; SAMRASS reporting for premature detonations or overbreaks.",

    evacuation: "Emergency evacuation procedures under MHSA emergency preparedness regulations.\n\nKey components:\n- Activation: Stench gas systems for underground alerts; self-escape routes marked with reflective signage.\n- Equipment: SCSRs for all personnel (training on donning/use); refuge chambers with air, water, first aid.\n- Execution: Designated assembly points, headcount verification via tags or electronic systems.\n- Drills: Quarterly simulations; SAMRASS for actual events like fires or outbursts.\n- Integration: Coordinated with ventilation/fire COPs for organized withdrawal.",

    fire: "Fire prevention, detection, and suppression under MHSA fire regulations.\n\nMulti-layered approach:\n- Prevention: Fuel source controls, hot work permits with fire watches, no-smoking zones.\n- Detection: Heat/smoke sensors, routine patrols in high-risk areas like conveyors.\n- Suppression: Fixed systems (deluge sprinklers, foam for flammable liquids), portable extinguishers classified by fire type.\n- Response: Trained firefighting teams, ventilation shutdown/isolation to contain smoke.\n- Reporting: SAMRASS for all fires; emphasis on minimizing secondary explosions in gassy mines.",

    tmm: "Trackless Mobile Machinery (TMM) operations under MHSA Chapter 8 Reg 8.10 (comprehensive TMM framework).\n\nBroad requirements:\n- Competency: Operator licensing with medical fitness, simulator/practical training.\n- Maintenance: Scheduled servicing (e.g., brakes weekly), defect reporting systems.\n- Technology: Level 9 collision avoidance (full intervention in high-risk); fleet management with fatigue detection.\n- Standards: Braking (fail-safe), visibility (360° cameras), ROPS/FOPS where needed.\n- Oversight: SAMRASS for accidents; mandatory TMM COPs to address ~30% of fatalities.",

    winders: "Winding plant, shafts, and headgears under MHSA Chapter 8 Reg 8.13 (2025 amendments, detailed up to Reg 8.13.139).\n\nIn-depth regulations:\n- Design/Installation: Approved engineering drawings, capacity limits, headgear stability assessments.\n- Operation: Winder controls with depth/speed indicators, overwind/underspeed prevention devices.\n- Components: Rope selection/inspections (non-destructive testing every 6 months), drum grooving, brake systems (dual independent).\n- Safety: Arrestors for falling conveyances, emergency power backups, signaling codes (bells/lights).\n- Personnel: Certified winder drivers, banksman/onsetter training; daily logbooks for operations.\n- Emergency: Procedures for rope severance, stuck conveyances; SAMRASS reporting for malfunctions.\n- Compliance: Replaces outdated Minerals Act Ch 16; focuses on preventing vertical transport failures.",

    community_chat: "Mining Community Group: Platform for GCC candidates & professionals to discuss, share knowledge, and network (not in Annexure E)."

    
};

const moduleResources = {
    handover: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Comprehensive guide on occupational safety practices including handover procedures.\n- <a href='https://www.coursehero.com/file/194217607/001-2023-3-bpdf/' target='_blank'>Essential Guide to Construction and Mining Safety Management</a> - Covers MHSA requirements for shift handover and pre-checks.\n- <a href='https://pmg.org.za/files/171003MHSC.pdf' target='_blank'>Guidelines for Recognition of Prior Learning and Training</a> - Includes modules on safe handover practices.",

    lhd: "- <a href='https://mandelaminingprecinct.org.za/wp-content/uploads/2021/09/Guideline-Mechanised-Equipment.pdf' target='_blank'>Guideline for Mechanised Equipment (Mandela Mining Precinct)</a> - Detailed guidelines for safe operation of LHD and other mechanised equipment.\n- <a href='https://www.gov.za/sites/default/files/gcis_document/202506/52781gon6266.pdf' target='_blank'>Guideline for COP on Road and Rail Safety Management</a> - Covers traffic management for TMM like LHD in declines.\n- <a href='https://www.holmessafety.org/wp-content/uploads/Combs-Task-Training.pdf' target='_blank'>Guidelines to Effective Task Training</a> - Includes OJT modules for LHD operations and safety.",

    drill: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Chapter on machinery safety including jumbo drilling.\n- <a href='https://minesafetyinstitute.org/purchase/msha-operators-guide' target='_blank'>MSHA Operator's Guide</a> - Training modules on drilling equipment safety (adaptable to MHSA).\n- <a href='https://mhsc.org.za/sites/default/files/public/publications/Handbook%20Pages%201-89.pdf' target='_blank'>Handbook on Mine Occupational Hygiene Measurements</a> - Guidance on dust suppression during drilling.",

    support: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Section on ground control and support installation.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre - Guidelines for Rock Fall and Rock Burst</a> - Combat rock fall accidents guidelines.\n- <a href='https://www.coursehero.com/file/194217607/001-2023-3-bpdf/' target='_blank'>Essential Guide to Construction and Mining Safety Management</a> - Covers support systems in mining.",

    vent: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Handbook%20Pages%201-89.pdf' target='_blank'>Handbook on Mine Occupational Hygiene Measurements</a> - Detailed ventilation monitoring and failure response.\n- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Chapter on environmental engineering and ventilation.\n- <a href='https://mqa.org.za/wp-content/uploads/2021/08/MQA-SSP-Final.pdf' target='_blank'>MQA Sector Skills Plan</a> - Training requirements for ventilation officers.",

    rockfall: "- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre - Guidelines for Rock Fall</a> - Specific guidelines to combat rock fall and burst accidents.\n- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Ground control and rock fall prevention.\n- <a href='https://www.coursehero.com/file/194217607/001-2023-3-bpdf/' target='_blank'>Essential Guide to Construction and Mining Safety Management</a> - Rock fall event management.",

    traffic: "- <a href='https://www.gov.za/sites/default/files/gcis_document/202506/52781gon6266.pdf' target='_blank'>Guideline for COP on Road and Rail Safety Management</a> - Traffic conflict management in single lanes.\n- <a href='https://mandelaminingprecinct.org.za/wp-content/uploads/2021/09/Guideline-Mechanised-Equipment.pdf' target='_blank'>Guideline for Mechanised Equipment</a> - TMM traffic rules.\n- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Machinery and traffic safety.",

    reentry: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Post-blast re-entry procedures.\n- <a href='https://www.ensafrica.com/uploads/newsarticles/0_13guide06.pdf' target='_blank'>Guideline for COP Occupational Health Programme</a> - Re-entry after blasting.\n- <a href='https://mhsc.org.za/sites/default/files/public/publications/Handbook%20Pages%201-89.pdf' target='_blank'>Handbook on Mine Occupational Hygiene Measurements</a> - Fume clearance monitoring.",

    shaft_sinking: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Shaft sinking safety.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre - Mine Equipment Safety</a> - Guidelines for shafts and winders.\n- <a href='https://mandelaminingprecinct.org.za/wp-content/uploads/2021/09/Guideline-Mechanised-Equipment.pdf' target='_blank'>Guideline for Mechanised Equipment</a> - Applicable to sinking equipment.",

    raise_drill: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Raise boring safety.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre - Mine Equipment Safety</a> - Drilling equipment guidelines.\n- <a href='https://www.holmessafety.org/wp-content/uploads/Combs-Task-Training.pdf' target='_blank'>Guidelines to Effective Task Training</a> - OJT for raise drilling.",

    lifting_operations: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Lifting operations chapter.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre - Mine Equipment Safety</a> - Lifting machinery guidelines.\n- <a href='https://www.ensafrica.com/uploads/newsarticles/0_13guide06.pdf' target='_blank'>Guideline for COP Occupational Health Programme</a> - Related to lifting hazards.",

    civil_structural: "- <a href='https://www.coursehero.com/file/194217607/001-2023-3-bpdf/' target='_blank'>Essential Guide to Construction and Mining Safety Management</a> - Civil and structural safety.\n- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Infrastructure maintenance.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre</a> - Structural integrity guidelines.\n\n<strong>Civil Presentation (Google Slides):</strong><br>\n<div class='ratio ratio-16x9 mt-3'>\n<iframe src='https://docs.google.com/presentation/d/e/2PACX-1vSkAO1aLSv1JpoWN8J5WEWs-M_38HhGEuc44tUvd-znI6suToh0dsK1sEZ8uzQrBg/pubembed?start=false&loop=false&delayms=3000' frameborder='0' allowfullscreen='true' mozallowfullscreen='true' webkitallowfullscreen='true'></iframe>\n</div>",


    conveyor_monorail: "- <a href='https://www.gov.za/sites/default/files/gcis_document/202506/52781gon6266.pdf' target='_blank'>Guideline for COP on Road and Rail Safety Management</a> - Applicable to monorails.\n- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Conveyor safety section.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre - Materials Handling</a> - Conveyor guidelines.\n\n<strong>Conveyor Presentation (Google Slides):</strong><br>\n<div class='ratio ratio-16x9 mt-3'>\n<iframe src='https://docs.google.com/presentation/d/e/2PACX-1vStkMHybEjouk3QlhWZkFBBys-NnovwAI71_2UZASN5p2P0KuASEi7Kt94EAEgkTA/pubembed?start=false&loop=false&delayms=3000' frameborder='0' allowfullscreen='true' mozallowfullscreen='true' webkitallowfullscreen='true'></iframe>\n</div>",

compressed_air: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Handbook%20Pages%201-89.pdf' target='_blank'>Handbook on Mine Occupational Hygiene Measurements</a> - Compressed air safety.\n- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Pressure vessel guidelines.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre - Mine Equipment Safety</a> - Compressed air regs.\n\n<strong>Compressor Presentation (Google Slides):</strong><br>\n<div class='ratio ratio-16x9 mt-3'>\n<iframe src='https://docs.google.com/presentation/d/e/2PACX-1vTGKK8B3ffFolrPBsohiPHguiKTjN8Sd9CsE-t0DZh-ivEfl1_Sedp49yxyY5NivA/pubembed?start=false&loop=false&delayms=3000' frameborder='0' allowfullscreen='true' mozallowfullscreen='true' webkitallowfullscreen='true'></iframe>\n</div>",

    pump_fluid: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Pumping and fluid handling.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre - Occupational Hygiene</a> - Water management guidelines.\n- <a href='https://mandelaminingprecinct.org.za/wp-content/uploads/2021/09/Guideline-Mechanised-Equipment.pdf' target='_blank'>Guideline for Mechanised Equipment</a> - Pump safety.",

    steam_pressure: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Steam and pressure vessel safety.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre - Mine Equipment Safety</a> - Pressure equipment guidelines.\n- <a href='https://www.ensafrica.com/uploads/newsarticles/0_13guide06.pdf' target='_blank'>Guideline for COP Occupational Health Programme</a> - Related to pressure hazards.\n\n<strong>Steam Generation (Google Slides):</strong><br>\n<div class='ratio ratio-16x9 mt-3'>\n<iframe src='https://docs.google.com/presentation/d/e/2PACX-1vQeaQTYpC_Lfy5wxnhRKVIbqCLdkFikKZkbbsTvLVfBoe_LbvlAqxPLwgDGFv3xnw/pubembed?start=false&loop=false&delayms=3000' frameborder='0' allowfullscreen='true' mozallowfullscreen='true' webkitallowfullscreen='true'></iframe>\n</div>",


    electrical: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Electrical systems chapter.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre - Mine Equipment Safety</a> - Electrical guidelines.\n- <a href='https://mqa.org.za/wp-content/uploads/2021/08/MQA-SSP-Final.pdf' target='_blank'>MQA Sector Skills Plan</a> - Electrical safety training.",

    mhsa: "- <a href='https://mqa.org.za/wp-content/uploads/2021/08/MQA-SSP-Final.pdf' target='_blank'>MQA Sector Skills Plan</a> - Overview of MHSA training requirements.\n- <a href='https://pmg.org.za/files/171003MHSC.pdf' target='_blank'>MHSC Presentation on Guidelines</a> - MHSA compliance guidelines.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre</a> - Full MHSA regulations and COP guidelines.",

    seismicity: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Seismicity and rockbursts section.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre - Rock Fall Guidelines</a> - Combat rock burst accidents.\n- <a href='https://www.coursehero.com/file/194217607/001-2023-3-bpdf/' target='_blank'>Essential Guide to Construction and Mining Safety Management</a> - Seismicity management.",

    blasting: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Blasting and explosives chapter.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre</a> - Explosives safety guidelines.\n- <a href='https://www.holmessafety.org/wp-content/uploads/Combs-Task-Training.pdf' target='_blank'>Guidelines to Effective Task Training</a> - Blasting OJT modules.",

    evacuation: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Emergency evacuation procedures.\n- <a href='https://www.ensafrica.com/uploads/newsarticles/0_13guide06.pdf' target='_blank'>Guideline for COP Occupational Health Programme</a> - Emergency preparedness.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre</a> - Emergency response guidelines.",

    fire: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Mine fires and explosions chapter.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre</a> - Fire safety guidelines.\n- <a href='https://repository.up.ac.za/bitstreams/1df5d4cb-1796-4f40-9d11-b58abfc827f5/download' target='_blank'>Education and Training in the Mining Sector</a> - Fire safety training modules.\n\n<strong>Steam Generation (Google Slides):</strong><br>\n<div class='ratio ratio-16x9 mt-3'>\n<iframe src='https://docs.google.com/presentation/d/e/2PACX-1vRjdIry8OtJBD2wte-xOUCLFgU6g-Pdf4cwcJwiQHOhmeoshnM9z56uDeKpVLMwQA/pubembed?start=false&loop=false&delayms=3000' frameborder='0' allowfullscreen='true' mozallowfullscreen='true' webkitallowfullscreen='true'></iframe>\n</div>",



    tmm: "- <a href='https://mandelaminingprecinct.org.za/wp-content/uploads/2021/09/Guideline-Mechanised-Equipment.pdf' target='_blank'>Guideline for Mechanised Equipment (Mandela Mining Precinct)</a> - TMM safety guidelines.\n- <a href='https://www.gov.za/sites/default/files/gcis_document/202506/52781gon6266.pdf' target='_blank'>Guideline for COP on Road and Rail Safety Management</a> - TMM traffic rules.\n- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Trackless machinery section.",

    winders: "- <a href='https://mhsc.org.za/sites/default/files/public/publications/Safety%20Handbook%20Manuscript%20Final.pdf' target='_blank'>Safety Handbook Manuscript Final (MHSC)</a> - Winding plant safety.\n- <a href='https://www.dmre.gov.za/mineral-resources/mine-health-and-safety/resource-center' target='_blank'>DMRE Resource Centre - Mine Equipment Safety</a> - Winding regulations.\n- <a href='https://www.coursehero.com/file/194217607/001-2023-3-bpdf/' target='_blank'>Essential Guide to Construction and Mining Safety Management</a> - Shaft and winder safety.",

    community_chat: "No additional resources available for this module."
};
